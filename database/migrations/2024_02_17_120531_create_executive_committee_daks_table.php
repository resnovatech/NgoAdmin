...
return new class extends Migration
{
    ...
    {
        Schema::create('executive_committee_daks', function (Blueprint $table) {
            $table->id();
            $table->string('sender_admin_id')->nullable();
            $table->string('receiver_admin_id')->nullable();
            $table->string('executive_committee_id')->nullable();
    ...
    {
        Schema::dropIfExists('executive_committee_daks');
    }
};
