...
<span>সকল এনজিও'র তালিকা</span><br>
                @elseif($type == 'দেশি')
                <span>দেশি এনজিও'র তালিকা</span><br>

                @else

                <span>বিদেশী এনজিও'র তালিকা</span><br>

                @endif
                @if(empty($to))

                <span>মাস: <b>{{ App\Http\Controllers\Admin\CommonController::englishToBangla($fromMonthName) }}</b>, সাল: <b>{{ App\Http\Controllers\Admin\CommonController::englishToBangla($year) }}</b></span>

                @else
                <span><b>{{ App\Http\Controllers\Admin\CommonController::englishToBangla($fromMonthName) }}</b> থেকে <b>{{ App\Http\Controllers\Admin\CommonController::englishToBangla($toMonthName)  }}</b> পর্যন্ত, সাল: <b>{{ App\Http\Controllers\Admin\CommonController::englishToBangla($year) }}</b></span>
                @endif
