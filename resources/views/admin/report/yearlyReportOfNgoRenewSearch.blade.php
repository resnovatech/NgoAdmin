    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="get" action="{{ route('yearlyReportOfNgoRenewSearch') }}">
                <div class="row">
                    <div class="col-sm-4">
                        <label>হইতে</label>
        ...
        <div class="col-sm-12"  >
            <div class="card">
                ...
                <div class="card-body">
                      ...
                      <a href="{{ route('yearlyReportOfNgoRenewSearchPrint',['fromYear'=>$from_year_name,'toYear'=>0,'type'=>$ngoType]) }}" class="btn btn-primary waves-effect  btn-sm waves-light" type="button" >
                        <i class="far fa-calendar-plus  mr-2"></i> প্রিন্ট করুন
                    </a>
                      @else
                <a href="{{ route('yearlyReportOfNgoRenewSearchPrint',['fromYear'=>$from_year_name,'toYear'=>$to_year_name,'type'=>$ngoType]) }}" class="btn btn-primary waves-effect  btn-sm waves-light" type="button" >
                    <i class="far fa-calendar-plus  mr-2"></i> প্রিন্ট করুন
                </a>
