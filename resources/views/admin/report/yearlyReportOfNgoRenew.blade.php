...
@section('title')
এনজিও'র  নিবন্ধন নবায়নের বার্ষিক রিপোর্ট | {{ $ins_name }}
@endsection
...
<div class="container-fluid">
    <div class="page-header">
        <div class="row">
            <div class="col-sm-6">
                <h3>এনজিও'র  নিবন্ধন নবায়নের বার্ষিক রিপোর্ট</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">হোম</a></li>
                    <li class="breadcrumb-item">রিপোর্ট</li>
                    <li class="breadcrumb-item">এনজিও'র  নিবন্ধন নবায়নের বার্ষিক রিপোর্ট</li>
                </ol>
            </div>
            <div class="col-sm-6">
            </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-12"  >
            <div class="card">
                ...
                <div class="card-body">
                <!-- new print button-->
                <a href="{{ route('yearlyReportOfNgoRenewPrint') }}" class="btn btn-primary waves-effect  btn-sm waves-light" type="button" >
