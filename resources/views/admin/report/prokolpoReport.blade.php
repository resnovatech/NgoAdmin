...
<div class="container-fluid">
    <div class="page-header">
        <div class="row">
            <div class="col-sm-6">
                <h3>সকল প্রকল্পের তালিকা</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">হোম</a></li>
                    <li class="breadcrumb-item">রিপোর্ট</li>
                    <li class="breadcrumb-item">সকল প্রকল্পের তালিকা</li>
                </ol>
            </div>
            <div class="col-sm-6">
            </div>
        ...
        <div class="col-sm-12"  >
            <div class="card">
                ...
                <div class="card-body">
                     ...
                     <!-- new print button-->
   <a target="_blank" href="{{ route('prokolpoReportPrint') }}" class="btn btn-primary waves-effect  btn-sm waves-light" type="button" >
    <i class="far fa-calendar-plus  mr-2"></i> প্রিন্ট করুন
</a>
<!-- end new print button -->


                    <div class="table-responsive product-table mt-1" >
