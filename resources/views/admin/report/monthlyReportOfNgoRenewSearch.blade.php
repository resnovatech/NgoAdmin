    ...
    <div class="row">
        ...
        <div class="col-sm-12"  >
            <div class="card">
                ...
                <a href="{{ route('monthlyReportOfNgoRenewSearchPrint',['month'=>$monthName,'to'=>0,'year'=>$yearName,'type'=>$ngoType]) }}" class="btn btn-primary waves-effect  btn-sm waves-light" type="button" >
                    <i class="far fa-calendar-plus  mr-2"></i> প্রিন্ট করুন
                </a>
                @else

                <a href="{{ route('monthlyReportOfNgoRenewSearchPrint',['month'=>$monthName,'to'=>$toMonthName,'year'=>$yearName,'type'=>$ngoType]) }}" class="btn btn-primary waves-effect  btn-sm waves-light" type="button" >
                    <i class="far fa-calendar-plus  mr-2"></i> প্রিন্ট করুন
                </a>
                @endif
