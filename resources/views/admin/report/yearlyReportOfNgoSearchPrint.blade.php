...
<span>সকল এনজিও'র তালিকা</span><br>
                ...
                <span>সাল: <b>{{ App\Http\Controllers\Admin\CommonController::englishToBangla($fromYear) }}</b></span>

                @else
                <span><b>{{ App\Http\Controllers\Admin\CommonController::englishToBangla($fromYear) }}</b> থেকে <b>{{ App\Http\Controllers\Admin\CommonController::englishToBangla($toYear)}}</b> সাল পর্যন্ত</span>
                @endif
