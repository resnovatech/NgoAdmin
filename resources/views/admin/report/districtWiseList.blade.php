...
?>
            ...
            <div class="row">
                ...
                <div class="col-xl-2 col-md-2 col-sm-2 box-col-2 des-xl-25 rate-sec">
                    <div class="card income-card card-primary bg-primary">
                        <div class="card-body text-center">

                            <h5>{{ App\Http\Controllers\Admin\CommonController::englishToBangla($totalNgoRegistration + $totalNgoRenew) }}</h5>
                            <p>মোট এনজিও</p>
                ...
                <div class="col-xl-2 col-md-2 col-sm-2 box-col-2 des-xl-25 rate-sec">
                    <div class="card income-card card-primary bg-primary">
                        <div class="card-body text-center">
                            ...
                            <h5>{{ App\Http\Controllers\Admin\CommonController::englishToBangla($foreignCountInRegistration + $foreignCountInRenew) }}</h5>
                            <p>মোট বিদেশী এনজিও</p>
                ...
                <div class="col-xl-2 col-md-2 col-sm-2 box-col-2 des-xl-25 rate-sec ">
                    <div class="card income-card card-primary bg-primary">
                        <div class="card-body text-center">
                            ...
                            <h5>{{ App\Http\Controllers\Admin\CommonController::englishToBangla($activeCountFirstRenew + $activeCountFirst)  }}</h5>
                            <p>মোট সক্রিয় বিদেশী এনজিও</p>
                    ...
                    <div class="table-responsive product-table" >
                        ...
                        <table  id="example" class="display" style="width:100%">
                            ...
                            <tbody id="searchTable">
                                ...
                                @foreach($allFdOneData as $key=>$allFdOneDatas)
                                <?php
                            ...
                            <span class="badge badge-primary text-light" style="font-size:12px;" > {{ $ngoAllDataFirst->ngo_type }}</span>
