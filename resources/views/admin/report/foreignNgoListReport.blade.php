...
@section('title')
বিদেশি এনজিও'র তালিকা | {{ $ins_name }}
@endsection
...
<div class="container-fluid">
    <div class="page-header">
        <div class="row">
            <div class="col-sm-6">
                <h3>বিদেশি এনজিও'র তালিকা</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">হোম</a></li>
                    <li class="breadcrumb-item">রিপোর্ট</li>
                    <li class="breadcrumb-item">বিদেশি এনজিও'র তালিকা</li>
                </ol>
            </div>
            <div class="col-sm-6">
            </div>
                            ...
                            <div class="col-xl-4 col-md-4 col-sm-4 box-col-4 des-xl-25 rate-sec ">
                                <div class="card income-card card-primary bg-primary">
                                    <div class="card-body text-center">
                                        ...
                                        <h5>{{ App\Http\Controllers\Admin\CommonController::englishToBangla($InactiveCountFirstRenew + $InactiveCountFirst)  }}</h5>
                                        <p>মোট নিষ্ক্রিয়  বিদেশী এনজিও</p>
                    ...
                    <div class="table-responsive product-table" >
                        ...
                        <table  id="example" class="display" style="width:100%">
                            ...
                            <tbody id="searchTable">
                                ...
                                @foreach($foreignNgoListReport as $allFdOneDatas)
