        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">এফসি-২ ফরম তালিকা</li>
                </ol>
            </div>
            <div class="col-sm-6">
            </div>
                ...
                <div class="card-body">
                    <div class="table-responsive product-table">
                        <table class="display" id="basic-1">
                            ...
                            <tbody>
                           @foreach($dataFromFc2Form as $dataFromFd6FormAll)
...
<!-- red background end -->
                                ...
                                <td>{{ $dataFromFd6FormAll->person_full_name }}</td>
                                        <td>{{ App\Http\Controllers\Admin\CommonController::englishToBangla($dataFromFd6FormAll->person_nid) }}</td>
                                        <td>{{ App\Http\Controllers\Admin\CommonController::englishToBangla($dataFromFd6FormAll->person_mobile) }}</td>
