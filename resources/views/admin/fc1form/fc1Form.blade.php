        ...
        <div class="card-body">
            <table class="table table-bordered mb-4">
                ...
                <tr>
                    ...
                    <td>: {{ \App\Models\ProjectSubject::where('id',$dataFromFc1Form->subject_id)->value('name')}}</td>
                </tr>
                ...
                <h5 class="mb-4">প্রকল্পের মেয়াদ</h5>
                    ...
                    <table class="table table-bordered mb-4">
                       ...
                       ->where('type','fcOne')->where('formId',$dataFromFc1Form->id)->get();
            ...
            <table class="table table-bordered mb-4">
                ...
                <tr>
                    ...
                    <td>:
                        ...
                        <a href="{{ route('fc1PdfDownload',$dataFromFc1Form->id) }}" target="_blank" class="btn btn-success">দেখুন</a>
                        @if(Route::is('addChildNote') || Route::is('viewChildNote'))

                        <button  href="{{ route('fc1PdfDownload',$dataFromFc1Form->id) }}" class="btn btn-secondary" id="attLink1"  data-name="কাজের নাম, অর্থের পরিমান ও মেয়াদকাল সুস্পষ্টভাবে উল্লেখপূর্বক কপি সংযুক্ত করতে হবে"><i class="fa fa-paperclip"></i></button>
                        <button  href="{{ route('fc1PdfDownload',$dataFromFc1Form->id) }}" class="btn btn-danger" id="copyLink1"><i class="fa fa-copy"></i></button>
            ...
            <table class="table table-bordered">
                <tr>
                    ...
                    <td>:
                        ...
                        <a href="{{ route('verified_fc_one_form',$dataFromFc1Form->id) }}" target="_blank" class="btn btn-success">দেখুন</a>
                        @if(Route::is('addChildNote') || Route::is('viewChildNote'))

                        <button  href="{{ route('verified_fc_one_form',$dataFromFc1Form->id) }}" class="btn btn-secondary" id="attLink1"  data-name="এককালীন অনুদান গ্রহণের আবেদন ফরম / এফসি-১ ফরম"><i class="fa fa-paperclip"></i></button>
                        <button  href="{{ route('verified_fc_one_form',$dataFromFc1Form->id) }}" class="btn btn-danger" id="copyLink1"><i class="fa fa-copy"></i></button>
