...
@section('title')
গঠনতন্ত্র পরিবর্তন/অনুমোদনের আবেদন তালিকা | {{ $ins_name }}
@endsection
...
<div class="container-fluid">
    <div class="page-header">
        <div class="row">
            <div class="col-sm-6">
                <h3>গঠনতন্ত্র পরিবর্তন/অনুমোদনের আবেদন তালিকা</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">হোম</a></li>
                    <li class="breadcrumb-item">গঠনতন্ত্র পরিবর্তন/অনুমোদন</li>
                    <li class="breadcrumb-item">গঠনতন্ত্র পরিবর্তন/অনুমোদনের আবেদন তালিকা</li>
                </ol>
            </div>
            <div class="col-sm-6">
            </div>
...
@endif
                                ...
                                <td>
                                    ...
                                    @if (Auth::guard('admin')->user()->can('constitutionView'))
                                    <button class="btn btn-primary btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('constitutionInfo.show',$all_data_for_new_list_all->id) }}';">বিস্তারিত দেখুন</button>
@endif
