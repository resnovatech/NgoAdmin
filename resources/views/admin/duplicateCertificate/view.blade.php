...
@section('title')
এনজিও ডুপ্লিকেট সনদপত্রের বিস্তারিত  | {{ $ins_name }}
@endsection
...
<div class="container-fluid">
    <div class="page-header">
        <div class="row">
            <div class="col-sm-6">
                <h3>এনজিও ডুপ্লিকেট সনদপত্রের তথ্য</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">হোম</a></li>
                    <li class="breadcrumb-item">এনজিও ডুপ্লিকেট সনদপত্রের তথ্য</li>
                    ...
                    <div class="col-sm-12">
                        <div class="card height-equal">
                            <div class="card-header pb-0">
                                <h5>এনজিও ডুপ্লিকেট সনদপত্রের সমস্ত তথ্য</h5>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="text-end">
                                           ...
                                           @if($getformOneId->status == 'Ongoing')
                                            <button onclick="location.href = '{{ route('showDataAll',['status'=>'duplicate','id'=>$getformOneId->id]) }}';" type="button" class="btn btn-primary float-right">ডাক দেখুন</button>
...
@endif
                                    ...
                                    <div class="tab-pane fade" id="pills-darkdoc" role="tabpanel"
                                      ...
                                      @include('admin.duplicateCertificate.documentList')
                                    </div>
