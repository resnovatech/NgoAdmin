...
@section('title')
এনজিও নির্বাহী কমিটি অনুমোদনের বিস্তারিত  | {{ $ins_name }}
@endsection
...
<div class="container-fluid">
    <div class="page-header">
        <div class="row">
            <div class="col-sm-6">
                <h3>এনজিও নির্বাহী কমিটি অনুমোদনের  তথ্য</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">হোম</a></li>
                    <li class="breadcrumb-item">এনজিও নির্বাহী কমিটি অনুমোদনের  তথ্য</li>
                    ...
                    <div class="col-sm-12">
                        <div class="card height-equal">
                            <div class="card-header pb-0">
                                <h5>এনজিও নির্বাহী কমিটি অনুমোদনের সমস্ত তথ্য</h5>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="text-end">
                                           ...
                                           @if($getformOneId->status == 'Ongoing')
                                            <button onclick="location.href = '{{ route('showDataAll',['status'=>'committee','id'=>$getformOneId->id]) }}';" type="button" class="btn btn-primary float-right">ডাক দেখুন</button>
...
@endif
                                    ...
                                    <div class="tab-pane fade" id="pills-darkdoc" role="tabpanel"
                                      ...
                                      @include('admin.executiveCommittee.documentList')
                                    </div>
                                   ...
                                   <div class="mb-0 m-t-30">
                                    ...
                                    $get_email_from_user = DB::table('users')->where('id',$fdOneFormId)->value('email');
                                            ...
                                            ?>
                                       <form id="form" action="{{ route('updateStatusexecutiveCommittee') }}" method="post">
                                           @csrf
