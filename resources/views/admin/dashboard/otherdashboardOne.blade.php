...
@endforeach
    ...
    <!-- end form no four --->
     ...
     <td style="text-align:right;">
         ...
         title="নথি জাত করুন"
         data-bs-toggle="modal"
         data-original-title="" data-bs-target="#nothiJatModalfdFourOneForm{{ $allStatusData->id }}">
         <i class="icofont icofont-rotation"></i> নথি জাত করুন
         </button>

         @include('admin.post.nothiJatModalfdFourOneForm')
              <!--new code-->
      <button type="button" class="btn btn-primary btn-xs"
      data-bs-toggle="modal"
      data-original-title="" data-bs-target="#myModalfdFourOneFormForm{{ $p }}">
      ডাক গতিবিধি
     </button>
     ...
     <!-- Modal -->
     <div class="modal right fade bd-example-modal-lg"
     id="myModalfdFourOneFormForm{{ $p }}" tabindex="-1" role="dialog"
     aria-labelledby="myModalLabel2">
     <div class="modal-dialog modal-lg" role="document">
     <div class="modal-content">
     <div class="modal-header">
