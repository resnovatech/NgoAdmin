...
<div class="container-fluid">
    <div class="page-header">
        <div class="row">
            <div class="col-sm-6">
                <h3>প্রকল্পের প্রত্যয়ন পত্র</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">হোম</a></li>
                    <li class="breadcrumb-item">ফরম নং - ৭</li>
                    <li class="breadcrumb-item">ফরম নং - ৭ এর বিবরণ</li>
                </ol>
            </div>
            <div class="col-sm-6">
            </div>
            ...
            <div class="card-body">
                ...
                <div class="row mb-4">
                    <div class="col-lg-12">
                        ...
                        <div class="text-end">
                            ...
                            @if($dataFromNoSevenForm->status == 'Ongoing')
                            <button onclick="location.href = '{{ route('showDataAll',['status'=>'formNoSeven','id'=>$dataFromNoSevenForm->mainId]) }}';" type="button" class="btn btn-primary add-btn">ডাক দেখুন</button>
                ...
                <ul class="nav nav-dark" id="pills-darktab" role="tablist">
                    <li class="nav-item"><a class="nav-link active" id="pills-darkhome-tab"
                                    ...
                                    class="icofont icofont-ui-home"></i>ফরম নং - ৭</a></li>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <form id="form" action="{{ route('statusUpdateForformNoSeven') }}" method="post">
                                                @csrf


                                                <input type="hidden" value="{{ $dataFromNoSevenForm->mainId }}" name="id" />
                                                ...
                                                <select class="form-control form-control-sm mt-4" name="status" id="regStatus">
                                                    ...
                                                    <option value="pending" {{ $dataFromNoSevenForm->status == 'pending' ? 'selected':''  }}>চলমান</option>

                                                    <option value="Accepted" {{ $dataFromNoSevenForm->status == 'Accepted' ? 'selected':''  }}>গৃহীত</option>
                                                    <option value="Correct" {{ $dataFromNoSevenForm->status == 'Correct' ? 'selected':''  }}>সংশোধন করুন</option>
                                                    <option value="Rejected" {{ $dataFromNoSevenForm->status == 'Rejected' ? 'selected':''  }}>প্রত্যাখ্যান করুন</option>

                                                </select>


                                                @if($dataFromNoSevenForm->status == 'Correct' || $dataFromNoSevenForm->status == 'Rejected')

                                                <div id="rValueStatus" >
                                                    <label>বিস্তারিত লিখুন:</label>
                                                    <textarea class="form-control form-control-sm" name="comment">{{ $dataFromNoSevenForm->comment }}</textarea>
                                                </div>
                                                @else
