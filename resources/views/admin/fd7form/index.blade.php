        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">এফডি - ৭ ফরম তালিকা</li>
                </ol>
            </div>
            <div class="col-sm-6">
            </div>
                ...
                <div class="card-body">
                    <div class="table-responsive product-table">
                        <table class="display" id="basic-1">
                            ...
                            <tbody>
                           @foreach($dataFromFd7Form as $dataFromFd6FormAll)
...
<!-- red background end -->
                                ...
                                <td>
                                    <button class="btn btn-primary btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('fd7Form.show',$dataFromFd6FormAll->id) }}';">বিস্তারিত দেখুন</button>
                                </td>
                            </tr>
                            @endforeach
                            </tbody>
