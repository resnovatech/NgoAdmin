            ...
            <table class="table table-bordered mb-4">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('fd7fd2PdfDownload',$fd2FormList->id) }}" target="_blank" class="btn btn-success">দেখুন</a>

                        @if(Route::is('addChildNote') || Route::is('viewChildNote'))

                        <button  href="{{ route('fd7fd2PdfDownload',$fd2FormList->id) }}" class="btn btn-secondary" id="attLink1"  data-name="এফডি ২ ফর্ম"><i class="fa fa-paperclip"></i></button>
                        <button  href="{{ route('fd7fd2PdfDownload',$fd2FormList->id) }}" class="btn btn-danger" id="copyLink1"><i class="fa fa-copy"></i></button>
            ...
            <table class="table table-bordered mb-4">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('fd7fd2OtherPdfDownload',$fd2OtherInfoAll->id) }}" target="_blank" class="btn btn-success">দেখুন</a>

                        @if(Route::is('addChildNote') || Route::is('viewChildNote'))

                        <button  href="{{ route('fd7fd2OtherPdfDownload',$fd2OtherInfoAll->id) }}" class="btn btn-secondary" id="attLink1"  data-name="{{ $fd2OtherInfoAll->file_name }}"><i class="fa fa-paperclip"></i></button>
                        <button  href="{{ route('fd7fd2OtherPdfDownload',$fd2OtherInfoAll->id) }}" class="btn btn-danger" id="copyLink1"><i class="fa fa-copy"></i></button>
