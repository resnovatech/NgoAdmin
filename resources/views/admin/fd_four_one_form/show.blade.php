        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">এফডি - ৪(১)  ফরম এর বিবরণ</li>
                </ol>
            </div>
            <div class="col-sm-6">
            </div>
            ...
            <div class="card-body">
                ...
                <div class="row mb-4">
                    <div class="col-lg-12">
                        ...
                        <div class="text-end">
                            ...
                            @if($dataFdFourOneForm->status == 'Ongoing')
                            <button onclick="location.href = '{{ route('showDataAll',['status'=>'fdFourOneForm','id'=>$dataFdFourOneForm->mainId]) }}';" type="button" class="btn btn-primary add-btn">ডাক দেখুন</button>
                ...
                <ul class="nav nav-dark" id="pills-darktab" role="tablist">
                    <li class="nav-item"><a class="nav-link active" id="pills-darkhome-tab"
                                    ...
                                    class="icofont icofont-ui-home"></i>এফডি - ৪(১)  ফরম</a></li>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <form id="form" action="{{ route('statusUpdateForfd4OneForm') }}" method="post">
                                                @csrf


                                                <input type="hidden" value="{{ $dataFdFourOneForm->mainId }}" name="id" />
                                                ...
                                                <select class="form-control form-control-sm mt-4" name="status" id="regStatus">
                                                    ...
                                                    <option value="pending" {{ $dataFdFourOneForm->status == 'pending' ? 'selected':''  }}>চলমান</option>

                                                    <option value="Accepted" {{ $dataFdFourOneForm->status == 'Accepted' ? 'selected':''  }}>গৃহীত</option>
                                                    <option value="Correct" {{ $dataFdFourOneForm->status == 'Correct' ? 'selected':''  }}>সংশোধন করুন</option>
                                                    <option value="Rejected" {{ $dataFdFourOneForm->status == 'Rejected' ? 'selected':''  }}>প্রত্যাখ্যান করুন</option>

                                                </select>


                                                @if($dataFdFourOneForm->status == 'Correct' || $dataFdFourOneForm->status == 'Rejected')

                                                <div id="rValueStatus" >
                                                    <label>বিস্তারিত লিখুন:</label>
                                                    <textarea class="form-control form-control-sm" name="comment">{{ $dataFdFourOneForm->comment }}</textarea>
                                                </div>
                                                @else
