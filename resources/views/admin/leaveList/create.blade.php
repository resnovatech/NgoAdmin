      ...
      <div class="row mt-5">
        <div class="col-sm-6">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item">আবেদনপত্র তৈরী করুন</li>
      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header pb-0">
            <h5>আবেদনপত্র তৈরী করুন </h5>
          </div>
          <div class="card-body">
            @include('flash_message')
            <form id="form" class="custom-validation" action="{{ route('leaveManagement.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                  <div class="row">
              ...
              <div class="form-group col-md-6 col-sm-6">
                  ...
                  <select class="form-control js-example-basic-single"  name="to_admin" placeholder="চাকরির শেষ তারিখ" required>
                    ...
                    <option value="{{ $adminLists->id }}">{{ $adminLists->admin_name_ban }}</option>
              ...
              <div class="form-group col-md-6 col-sm-6">
                ...
                <input type="text" class="form-control" id="position" name="subject" placeholder="বিষয়">
            </div>
            ...
            <div class="form-group col-md-12 col-sm-12">
                ...
                <input type="text" class="form-control datepicker233" id="date" name="applicate_date" placeholder="আবেদনের তারিখ">
            </div>
