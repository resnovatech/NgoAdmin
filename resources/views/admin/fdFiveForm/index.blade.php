...
@section('title')
বিদেশ থেকে প্রাপ্ত জিনিসপত্র /দ্রব্যসামগ্র্রীর সংরক্ষণ সংক্রান্ত ফরম এর তালিকা  | {{ $ins_name }}
@endsection
...
<div class="container-fluid">
    <div class="page-header">
        <div class="row">
            <div class="col-sm-6">
                <h3>বিদেশ থেকে প্রাপ্ত জিনিসপত্র /দ্রব্যসামগ্র্রীর সংরক্ষণ সংক্রান্ত ফরম এর তালিকা</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">হোম</a></li>
                    <li class="breadcrumb-item">বিদেশ থেকে প্রাপ্ত জিনিসপত্র /দ্রব্যসামগ্র্রীর সংরক্ষণ সংক্রান্ত ফরম</li>
                    <li class="breadcrumb-item">বিদেশ থেকে প্রাপ্ত জিনিসপত্র /দ্রব্যসামগ্র্রীর সংরক্ষণ সংক্রান্ত ফরম এর তালিকা</li>
                </ol>
            </div>
            <div class="col-sm-6">
            </div>
                        ...
                        <table class="display" id="basic-1">
                         ...
                         <tr>
                            ...
                            <tbody>
                                ...
                                <?php
                               $fdOneFormId = DB::table('fd_one_forms')->where('id',$all_data_for_new_list_all->fdId)->value('user_id');
                                $reg_number = DB::table('fd_one_forms')->where('id',$all_data_for_new_list_all->fdId)->first();
...
@endif
                                ...
                                <td>
                                    ...
                                    @if (Auth::guard('admin')->user()->can('fd5_formsView'))
                                    <button class="btn btn-primary btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('fd5Form.show',$all_data_for_new_list_all->id) }}';">বিস্তারিত দেখুন</button>
@endif
