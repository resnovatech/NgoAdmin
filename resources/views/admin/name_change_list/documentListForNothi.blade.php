...
@elseif(($key+1) ==3)
    ...
    <td>
        <button  href="{{ route('nameChangeDoc',$AllNameChangeInfoDoc->id) }}" class="btn btn-secondary" id="attLink1"  data-name="গঠনতন্ত্র পরিবর্তন ফি বাবদ- ১৩,০০০/- (তের হাজার) টাকার (কোড নং-১-০৩২৩-০০০০- ১৮৩৬) চালানের মূলকপি এবং ১৫% (কোড নং -১-১১৩৩-০০৩৫-০৩১১) জমাপূর্বক চালানের মূলকপিসহ"><i class="fa fa-paperclip"></i></button>
        <button  href="{{ route('nameChangeDoc',$AllNameChangeInfoDoc->id) }}" class="btn btn-danger" id="copyLink1"><i class="fa fa-copy"></i></button>
    </td>
...
@elseif(($key+1) ==3)
    ...
    <td>
        <button  href="{{ route('nameChangeDoc',$AllNameChangeInfoDoc->id) }}" class="btn btn-secondary" id="attLink1"  data-name="গঠনতন্ত্র পরিবর্তন ফি বাবদ- ১৩,০০০/- (তের হাজার) টাকার (কোড নং-১-০৩২৩-০০০০- ১৮৩৬) চালানের মূলকপিসহ"><i class="fa fa-paperclip"></i></button>
        <button  href="{{ route('nameChangeDoc',$AllNameChangeInfoDoc->id) }}" class="btn btn-danger" id="copyLink1"><i class="fa fa-copy"></i></button>
    </td>
