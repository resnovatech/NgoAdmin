    ...
    <td>
        <p>
            <div class="form-check form-check-inline checkbox checkbox-primary">
                <input class="form-check-input" data-dakid="{{ $dakId }}" data-dakstatus="fdNineOne"  data-nothiid="{{ $nothiLists->id }}" id="nothijatFdNineOneFinal{{ $nothiLists->id }}" type="checkbox">
