...
//end new code
    ...
    ->where('id',$decesionNameId)->where('status','duplicate')->value('decision_list');
                    ...
                    ?>
                     ...
                     @include('admin.post.receivedDuplicateCertificateDak')
                ...
                <tr>
                    ...
                    <td style="text-align:right;">
                        <button class="btn btn-primary btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('showDataAll',['status'=>'duplicate','id'=>$allStatusData->id]) }}';">প্রেরণ</button>
