...
<div class="modal right fade bd-example-modal-lg"
     id="nothiJatModalrenew{{ $allStatusData->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg-custom"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h5>একশনঃ নথিতে উপস্থাপনঃ এনজিও নবায়ন   </h5>
                <div class="row">
                    <div class="col-lg-6">
                        <h5>সকল নথি</h5>
                    </div>
                    ...
                    <div class="col-lg-12 mt-3">
                        <div class="input-group">
                            <input class="form-control"  id="nothijatSearchRenw{{ $allStatusData->id }}" type="text" placeholder="নথি খুজুন"><span
                    ...
                    <div class="col-lg-12 mt-3">
                        <div class="table-responsive">
                            <div class="accordion accordion-flush" id="accordionFlushExample">
                                <table class="table table-striped" id="nothijatSearchResultRenw{{ $allStatusData->id }}">
                                    <tbody>
                                            ...
                                            <td>
                                                <p>
                                                    <div class="form-check form-check-inline checkbox checkbox-primary">
                                                        <input class="form-check-input" data-dakid="{{ $allStatusData->id }}" data-dakstatus="renew"  data-nothiid="{{ $nothiLists->id }}" id="nothijatRenwFinal{{ $nothiLists->id }}" type="checkbox">
                                                        <label class="form-check-label" for="nothijatRenwFinal{{ $nothiLists->id }}"></label>
                                                      </div>
