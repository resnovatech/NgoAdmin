...
<div class="modal right fade bd-example-modal-lg"
     id="nothiJatModalFdThreecons{{ $allStatusData->id }}" tabindex="-1" role="dialog"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 mt-3">
                        <div class="input-group">
                            <input class="form-control"  id="nothiJatSearchConstitution{{ $allStatusData->id }}" type="text" placeholder="নথি খুজুন"><span
                    ...
                    <div class="col-lg-12 mt-3">
                        <div class="table-responsive">
                            <div class="accordion accordion-flush" id="accordionFlushExample">
                                <table class="table table-striped" id="nothijatSearchResultConstitution{{ $allStatusData->id }}">
                                    <tbody>
                                            ...
                                            <td>
                                                <p>
                                                    <div class="form-check form-check-inline checkbox checkbox-primary">
                                                        <input class="form-check-input" data-dakid="{{ $allStatusData->id }}" data-dakstatus="constitution"  data-nothiid="{{ $nothiLists->id }}" id="nothijatConstitutionFinal{{ $nothiLists->id }}" type="checkbox">
                                                        <label class="form-check-label" for="nothijatConstitutionFinal{{ $nothiLists->id }}"></label>
                                                      </div>
