...
@foreach($ngoStatusFormNoFour as $i=>$allStatusData)
<?php
...
$formOneDataId = DB::table('ngo_statuses')->where('id',$allStatusData->form_no_four_status_id)
...
data-bs-toggle="modal"
data-original-title="" data-bs-target="#myModalregformNoFour{{ $i }}">
ডাক গতিবিধি
</button>
...
id="myModalregformNoFour{{ $i }}" tabindex="-1" role="dialog"
