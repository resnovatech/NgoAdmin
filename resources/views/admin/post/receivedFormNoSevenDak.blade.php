...
@foreach($ngoStatusFormNoSeven as $i=>$allStatusData)
<?php
...
$formOneDataId = DB::table('ngo_statuses')->where('id',$allStatusData->form_no_seven_status_id)
...
data-bs-toggle="modal"
data-original-title="" data-bs-target="#myModalregformNoSeven{{ $i }}">
ডাক গতিবিধি
</button>
...
id="myModalregformNoSeven{{ $i }}" tabindex="-1" role="dialog"
