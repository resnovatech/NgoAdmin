    ...
    <td>
        <p>
            <div class="form-check form-check-inline checkbox checkbox-primary">
                <input class="form-check-input" data-dakid="{{ $dakId }}" data-dakstatus="nameChange"  data-nothiid="{{ $nothiLists->id }}" id="nothijatNameChangeFinal{{ $nothiLists->id }}" type="checkbox">
