 ...
 @foreach($ngoStatusFdFiveDak as $p=>$allStatusData)
...
<!-- red background end -->
 ...
 <td style="text-align:right;">
     ...
     <button class="btn btn-primary btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('executiveCommitteeInfo.show',$allStatusData->fd_five_status_id) }}';">দেখুন</button>
...
->where('fd_five_status_id',$allStatusData->fd_five_status_id)->orderBy('id','asc')->get();
