...
<div class="container-fluid">
    <div class="page-header">
        <div class="row">
            <div class="col-sm-6">
                <h3>নথি জাত ডাক তালিকা</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">হোম</a></li>
                    <li class="breadcrumb-item">ডাক </li>
                    <li class="breadcrumb-item">নথি জাত ডাক তালিকা</li>
                </ol>
            </div>
            <div class="col-sm-6">
            </div>
...
<!-- red background end -->
                                        ...
                                        <td style="text-align:right;">
                                            ...
                                            <button class="btn btn-danger btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('returnToAgotoDak',['id'=>$allStatusData->id,'status'=>'registration']) }}';"><i class="icofont icofont-undo"></i> ফেরত আনুন </button>
...
<!-- red background end -->
                                    ...
                                    <td style="text-align:right;">
                                        <button class="btn btn-danger btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('returnToAgotoDak',['id'=>$allStatusData->id,'status'=>'renew']) }}';"><i class="icofont icofont-undo"></i> ফেরত আনুন </button>
...
<!-- red background end -->
      ...
      <td style="text-align:right;">
          ...
          <button class="btn btn-danger btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('returnToAgotoDak',['id'=>$allStatusData->id,'status'=>'duplicate']) }}';"><i class="icofont icofont-undo"></i> ফেরত আনুন </button>
...
<!-- red background end -->
       ...
       <td style="text-align:right;">
           ...
           <button class="btn btn-danger btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('returnToAgotoDak',['id'=>$allStatusData->id,'status'=>'fdFive']) }}';"><i class="icofont icofont-undo"></i> ফেরত আনুন </button>
 ...
 ->orderBy('id','asc')->get();
  ...
  $decesionName = DB::table('dak_details')
  ->where('id',$allStatusData->dak_detail_id)->where('status','fromNoFive')->value('decision_list');
       ?>
   <!-- red background start --->
...
<!-- red background end -->
       ...
       <td style="text-align:right;">
           ...
           <button class="btn btn-danger btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('returnToAgotoDak',['id'=>$allStatusData->id,'status'=>'formNoFive']) }}';"><i class="icofont icofont-undo"></i> ফেরত আনুন </button>
 ...
 ->orderBy('id','asc')->get();
  ...
  $decesionName = DB::table('dak_details')
  ->where('id',$allStatusData->dak_detail_id)->where('status','formNoSeven')->value('decision_list');
       ?>
   <!-- red background start --->
...
<!-- red background end -->
       ...
       <td style="text-align:right;">
           ...
           <button class="btn btn-danger btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('returnToAgotoDak',['id'=>$allStatusData->id,'status'=>'formNoSeven']) }}';"><i class="icofont icofont-undo"></i> ফেরত আনুন </button>
...
->where('id',$allStatusData->form_no_four_status_id)
->value('fd_one_form_id');
...
<!-- red background end -->
     ...
     <td style="text-align:right;">
         ...
         <button class="btn btn-danger btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('returnToAgotoDak',['id'=>$allStatusData->id,'status'=>'formNoFour']) }}';"><i class="icofont icofont-undo"></i> ফেরত আনুন </button>
...
$formOneDataId = DB::table('fd4_one_forms')
->where('id',$allStatusData->fd4_one_form_status_id)
->value('fd_one_form_id');
...
<!-- red background end -->
     ...
     <td style="text-align:right;">
         ...
         <button class="btn btn-danger btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('returnToAgotoDak',['id'=>$allStatusData->id,'status'=>'fdFourOneForm']) }}';"><i class="icofont icofont-undo"></i> ফেরত আনুন </button>


              <!--new code-->
      <button type="button" class="btn btn-primary btn-xs"
      data-bs-toggle="modal"
      data-original-title="" data-bs-target="#myModalformNoFdFourOne{{ $p }}">
      ডাক গতিবিধি
</button>
...
<!-- Modal -->
<div class="modal right fade bd-example-modal-lg"
id="myModalformNoFdFourOne{{ $p }}" tabindex="-1" role="dialog"
aria-labelledby="myModalLabel2">
<div class="modal-dialog modal-lg" role="document">
 <div class="modal-content">
     <div class="modal-header">
