...
<!-- red background end -->
                    ...
                    <td style="text-align:right;">
                        <button class="btn btn-primary btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('showDataAll',['status'=>'formNoSeven','id'=>$allStatusData->id]) }}';">প্রেরণ</button>
                     ...
                     data-original-title="" data-bs-target="#myModalformNoSevenForm{{ $ps }}">
                     ডাক গতিবিধি
             </button>
             ...
             id="myModalformNoSevenForm{{ $ps }}" tabindex="-1" role="dialog"
