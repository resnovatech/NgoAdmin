                    ...
                    $checkDataAvailableOrNot = DB::table('ngo_fd_seven_daks')
...
//end new code
    ...
    ->where('id',$decesionNameId)->where('status','fdSeven')->value('decision_list');
                    ...
                    ?>
                     ...
                     @include('admin.post.receivedFdSevenDak')
...
<!-- red background end -->
                    ...
                    <td style="text-align:right;">
                        <button class="btn btn-primary btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('showDataAll',['status'=>'fdSeven','id'=>$allStatusData->mainId]) }}';">প্রেরণ</button>
