...
@foreach($ngoStatusFormNoFive as $i=>$allStatusData)
<?php
...
$formOneDataId = DB::table('ngo_statuses')->where('id',$allStatusData->form_no_five_status_id)
...
data-bs-toggle="modal"
data-original-title="" data-bs-target="#myModalregformNoFive{{ $i }}">
ডাক গতিবিধি
</button>
...
id="myModalregformNoFive{{ $i }}" tabindex="-1" role="dialog"
