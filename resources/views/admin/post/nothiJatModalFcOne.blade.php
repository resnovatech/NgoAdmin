                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 mt-3">
                        <div class="input-group">
                            <input class="form-control"  id="nothiJatSearchFcOne{{ $allStatusData->id }}" type="text" placeholder="নথি খুজুন"><span
                    ...
                    <div class="col-lg-12 mt-3">
                        <div class="table-responsive">
                            <div class="accordion accordion-flush" id="accordionFlushExample">
                                <table class="table table-striped" id="nothijatSearchResultFcOne{{ $allStatusData->id }}">
                                    <tbody>
                                            ...
                                            <td>
                                                <p>
                                                    <div class="form-check form-check-inline checkbox checkbox-primary">
                                                        <input class="form-check-input" data-dakid="{{ $allStatusData->id }}" data-dakstatus="fcOne"  data-nothiid="{{ $nothiLists->id }}" id="nothijatFcOneFinal{{ $nothiLists->id }}" type="checkbox">
                                                        <label class="form-check-label" for="nothijatFcOneFinal{{ $nothiLists->id }}"></label>
                                                      </div>
