    ...
    <td>
        <p>
            <div class="form-check form-check-inline checkbox checkbox-primary">
                <input class="form-check-input" data-dakid="{{ $dakId }}" data-dakstatus="duplicate"  data-nothiid="{{ $nothiLists->id }}" id="nothijatDuplicateFinal{{ $nothiLists->id }}" type="checkbox">
