...
@section('body')
  <div class="container-fluid">
                <div class="page-header">
                    <div class="row">
                        <div class="col-sm-6">
                            <h3>নথি সংশোধন করুন</h3>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">হোম</a></li>
                                <li class="breadcrumb-item">নথি সংশোধন করুন</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header pb-0">
                                <h5>নথি সংশোধন করুন</h5>
                            </div>
                            <form class="form theme-form" action="{{ route('documentPresent.update',$nothiList->id) }}" method="post" enctype="multipart/form-data" id="form" data-parsley-validate="">
                                 @csrf
@method('PUT')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control" name="document_class" id="" required>
                                                    ...
                                                    <option value="ক" {{ $nothiList->document_class == 'ক' ? 'selected':'' }}>ক</option>
                                                    <option value="খ" {{ $nothiList->document_class == 'খ' ? 'selected':'' }}>খ</option>
                                                    <option value="গ" {{ $nothiList->document_class == 'গ' ? 'selected':'' }}>গ</option>
                                                    <option value="ঘ" {{ $nothiList->document_class == 'ঘ' ? 'selected':'' }}>ঘ</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-xl-12 col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" required name="document_subject" value="{{ $nothiList->document_subject }}" type="text" placeholder="নথির বিষয়">
                                            </div>
                                        </div>
                                    </div>
