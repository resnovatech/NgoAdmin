...
id="modalfornewsenderreturn1{{ $childNoteNewLists->id }}"  role="dialog"
aria-labelledby="myModalLabel2">
<div class="modal-dialog modal-lg" role="document">
<div class="modal-content">
<div class="modal-header">
    <p id="pp" class="btn btn-outline-danger btn-sm"><i class="fa fa-times" aria-hidden="true"></i></p>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                <div class="">
                                                    ...
                                                    border-radius: 4px;
                                                    " id="ccccheck{{ $finalAdminLists->id }}" value="{{ $finalAdminLists->id }}" {{ $receiverId == $finalAdminLists->id ? 'checked':'' }}  name="nothiPermissionId" class="custom_checkbox chb" type="checkbox">
                                                    @endif
