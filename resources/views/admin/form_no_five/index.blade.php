        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">ফরম নং - ৫ তালিকা</li>
                </ol>
            </div>
            <div class="col-sm-6">
            </div>
                ...
                <div class="card-body">
                    <div class="table-responsive product-table">
                        <table class="display" id="basic-1">
                            ...
                            <tbody>
                           @foreach($dataFromNoFiveForm as $dataFromNoFiveFormAll)

                           <?php

                           $form_one_data = DB::table('fd_one_forms')
                           ->where('id',$dataFromNoFiveFormAll->fd_one_form_id)->first();
...
<!-- red background end -->
                                ...
                                <td>@if($dataFromNoFiveFormAll->status == 'Ongoing')
                                    ...
                                    চলমান
                                                                       ...
                                                                       @elseif($dataFromNoFiveFormAll->status == 'Accepted')
                                                                        ...
                                                                        @elseif($dataFromNoFiveFormAll->status == 'Correct')
                                                                        <button class="btn btn-secondary btn-xs" type="button">
                                                                            সংশোধন করুন
                                                                        ...
                                                                        @endif</td>
                                <td>{{ App\Http\Controllers\Admin\CommonController::englishToBangla($dataFromNoFiveFormAll->created_at) }}</td>
                                <td>
                                    <button class="btn btn-primary btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('formNoFive.show',$dataFromNoFiveFormAll->id) }}';">বিস্তারিত দেখুন</button>
                                </td>
                            </tr>
                            @endforeach
                            </tbody>
