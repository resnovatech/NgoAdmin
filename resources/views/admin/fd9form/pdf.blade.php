            ...
            <div class="form9_upper_box">
                ...
                <div>
                    <p>বরাবর <br>
                        ...
                        <p>নিম্নলখিত নিয়োগপ্রাপ্ত বিদেশি নাগরিক/নাগরিকগণকে এ সংস্থায় (নিবন্ধন নম্বরঃ {{App\Http\Controllers\Admin\CommonController::englishToBangla($checkNgoTypeForForeginNgo->registration)}}
                            তারিখঃ {{ App\Http\Controllers\Admin\CommonController::englishToBangla(date('d-m-Y', strtotime(\Carbon\Carbon::parse($ngoStatus->updated_at)->toDateString()))) }}) বৈদেশিক
        ...
        <div class="card-body">
            <table class="table table-borderless">
                ...
                <tr>
                    ...
                    <td>:  {{ $dataFromNVisaFd9Fd1->fd9_birth_place }}, {{ App\Http\Controllers\Admin\CommonController::englishToBangla(date('d-m-Y', strtotime($dataFromNVisaFd9Fd1->fd9_dob))) }}</td>
                </tr>
                <tr>
                    <td>৪.</td>
...
<?php
                         ...
                         $file_path = url($dataFromNVisaFd9Fd1->fd9_academic_qualification);
...
<?php
                         ...
                         $file_path = url($dataFromNVisaFd9Fd1->fd9_technical_and_other_qualifications_if_any);
                         $filename  = pathinfo($file_path, PATHINFO_FILENAME);
...
<?php
                         ...
                         $file_path = url($dataFromNVisaFd9Fd1->fd9_past_experience);
                         $filename  = pathinfo($file_path, PATHINFO_FILENAME);
...
<?php
                         ...
                         $file_path = url($dataFromNVisaFd9Fd1->fd9_offered_post);
                         $filename  = pathinfo($file_path, PATHINFO_FILENAME);
...
<?php
                         ...
                         $file_path = url($dataFromNVisaFd9Fd1->fd9_name_of_proposed_project);
                         $filename  = pathinfo($file_path, PATHINFO_FILENAME);
...
<?php
                         ...
                         $file_path = url($dataFromNVisaFd9Fd1->fd9_copy_of_passport);
                         $filename  = pathinfo($file_path, PATHINFO_FILENAME);
...
<p>আমি এই মর্মে ঘোষণা করছি যে ,আমি সংশ্লিষ্ট সকল আইন-কানুন পড়িয়াছি এবং উল্লিখিত সকল তথ্য সত্য ও সঠিক।</p>
        ...
        <table style=" margin-top: 10px;width:100%">
            ...
            <tr>
                ...
                <td style="width:30%; text-align: left;">: {{ $dataFromNVisaFd9Fd1->chief_name }}</td>
            </tr>
            <tr>
                <td style="width: 65%"></td>
                <td style="text-align: left; width: 5%;">পদবি </td>
                <td style="width:30%; text-align: left;">: {{ $dataFromNVisaFd9Fd1->chief_desi }}</td>
            </tr>
            ...
            <tr>
                ...
                <td style="width:30%; text-align: left;">: {{  App\Http\Controllers\Admin\CommonController::englishToBangla(date('d-m-Y', strtotime(\Carbon\Carbon::parse($dataFromNVisaFd9Fd1->created_at)->toDateString()))) }}</td>
