...
<html lang="en">
  <head>
    ...
    <!-- Plugins css start-->
    <link rel="stylesheet" type="text/css" href="{{ asset('/') }}public/new_admin/assets/css/sweetalert2.css">
    <!-- Plugins css Ends-->
    <!-- Bootstrap css-->
  ...
  <body>
        ...
        <div class="row">
          <div class="col-12">
            <div class="login-card">
              <form class="theme-form login-form" action="{{route('admin.login.submit')}}" method="post">
                @csrf
                <h4>Login</h4>
    ...
    <!-- Plugins JS start-->
    <script src="{{ asset('/') }}public/new_admin/assets/js/sweet-alert/sweetalert.min.js"></script>
    <!-- Plugins JS Ends-->
    <!-- Theme js-->
