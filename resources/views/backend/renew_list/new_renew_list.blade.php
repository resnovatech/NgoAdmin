                        ...
                        <table class="display" id="basic-1">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-primary btn-xs" type="button" data-original-title="btn btn-danger btn-xs" title="" onclick="location.href = '{{ route('renew_view',$all_data_for_new_list_all->user_id) }}';">View</button>
@endif
