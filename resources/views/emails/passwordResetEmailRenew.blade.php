...
your Renew has been {{ $id }}. We'll assess the situation, and consider the next steps. Your dedication remains valuable, and we'll overcome this setback together.
...
<p>We are excited to announce that you NGO Renew Request, <b>[{{$get_user_id}}]</b>, has been officially Accepted! 🎉 <b style="font-size: 18px;">Congratulations</b>
