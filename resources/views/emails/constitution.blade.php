...
your Name Chnage has been {{ $id }}. We'll assess the situation, and consider the next steps. Your dedication remains valuable, and we'll overcome this setback together.
...
<p>We are excited to announce that your NGO Constitution Amendment/Approval, <b>[{{$get_user_id}}]</b>, has been officially Accepted! 🎉 <b style="font-size: 18px;">Congratulations</b>
...
<b>
@if($id = 'Correct')
your NGO Constitution Amendment/Approval request need some Correction.
@else
your NGO Constitution Amendment/Approval request has been {{ $id }}.
