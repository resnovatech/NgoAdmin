...
your <b>Project Certification Request</b> has been {{ $id }}. We'll assess the situation, and consider the next steps. Your dedication remains valuable, and we'll overcome this setback together.
...
<p>We are excited to announce that your <b>Project Certification Request</b>, has been officially Accepted! 🎉 <b style="font-size: 18px;">Congratulations</b>
...
<b>
    @if($id = 'Correct')
    your <b>Project Certification Request</b> need some Correction.
    @else
    your <b>Project Certification Request</b> has been {{ $id }}.
