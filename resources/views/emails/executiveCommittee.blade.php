...
<p>We are excited to announce that your NGO Executive Committee Aproval, <b>[{{$get_user_id}}]</b>, has been officially Accepted! 🎉 <b style="font-size: 18px;">Congratulations</b>
...
<b>
@if($id = 'Correct')
your NGO Executive Committee Aproval request need some Correction.
@else
your NGO Executive Committee Aproval request has been {{ $id }}.
