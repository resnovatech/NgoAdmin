...
<p>We are excited to announce that your Fd Five Form, <b>[{{$get_user_id}}]</b>, has been officially Accepted! 🎉 <b style="font-size: 18px;">Congratulations</b>
...
<b>
@if($id = 'Correct')
your Fd Five Form request need some Correction.
@else
your Fd Five Form request has been {{ $id }}.
