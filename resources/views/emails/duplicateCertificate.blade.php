...
<p>We are excited to announce that your NGO Duplicate Certificate, <b>[{{$get_user_id}}]</b>, has been officially Accepted! 🎉 <b style="font-size: 18px;">Congratulations</b>
...
<b>
@if($id = 'Correct')
your NGO Duplicate Certificate request need some Correction.
@else
your NGO Duplicate Certificate request has been {{ $id }}.
